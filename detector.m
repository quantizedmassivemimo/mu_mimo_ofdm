...
function [LLR_E1,Stats] = detector(TxRx,yQ,tN,sN,N0,HN)
...
for kk = 1:TxRx.Nrx
    for ll = 1:TxRx.Ntx
        ...
        %%%timedomain(1:TxRx.Channel.Ntaps) = timedomain(1:TxRx.Channel.Ntaps)/(1+t/VAR); % shrink
